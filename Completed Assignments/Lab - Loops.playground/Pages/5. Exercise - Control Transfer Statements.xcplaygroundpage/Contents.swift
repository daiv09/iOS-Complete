...
let myDictionary:[String:String] = ["Maharashtra": "Mumbai", "Karnataka": "Bengaluru", "Gujarat": "Ahemdabad"]
for str in myDictionary{
    print("\(str.value) is capital of \(str.key)")
    if str.key == "Karnataka"{

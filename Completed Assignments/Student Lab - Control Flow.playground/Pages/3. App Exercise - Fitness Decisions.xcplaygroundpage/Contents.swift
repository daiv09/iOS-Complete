 ...
 */
let stepsGoal=100_00
let halfOfStepsGoal=stepsGoal/2
var steps=99_999

if steps<halfOfStepsGoal {
...
let oneTenThousandOfStepsGoal=stepsGoal/10
if steps<oneTenThousandOfStepsGoal {
    print("You're almost halfway there!")
} else if steps<halfOfStepsGoal {
    print("You're over halfway there!")
}
/*:

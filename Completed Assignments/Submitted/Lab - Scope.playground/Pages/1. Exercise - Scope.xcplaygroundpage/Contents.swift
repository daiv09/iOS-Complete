...
//print("The value of foo is \(foo)")
print("foo is a local variable and its scope is confined to the function. Thus, this will not compile.")
...
print("x in loop is a local variable. When x is called ouside the loop, it is a global variable and its value is retained. foo is a local variable and its scope is confined to the function. Thus, this will not compile.")

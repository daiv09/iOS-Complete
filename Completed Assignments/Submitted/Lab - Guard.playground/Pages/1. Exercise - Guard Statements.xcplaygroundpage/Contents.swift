...
calculateArea(x: 12.0, y: 11.0)
calculateArea(x: -1, y: 3.0)
...
var fname = createUser()?.firstName
var lname = createUser()?.lastName
var age = createUser()?.age
print("Hello, my name is \(fname!) \(lname!). I am \(age!) years old.")
/*:

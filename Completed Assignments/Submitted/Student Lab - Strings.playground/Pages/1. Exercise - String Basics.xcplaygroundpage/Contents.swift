 ...
 */
let myFavQuote="If we don't find a way to travel millions of times faster than the speed of light then we are getting nowhere"
print("My favourite qote is \"\(myFavQuote)\"")

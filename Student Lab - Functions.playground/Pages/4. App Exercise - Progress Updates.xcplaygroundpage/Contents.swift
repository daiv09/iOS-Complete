...
func progressUpdate (steps: Int, goal: Int) {
    if steps < goal * 10 / 100 {
        ...
        print("You have beaten the goal!")
    }
}
progressUpdate(steps: 200, goal: 2000)
progressUpdate(steps: 2000, goal: 200)
...
pacing(currentDistance: 27, totalDistance: 40, currentTime: 20, goalTime: 40)
/*:
